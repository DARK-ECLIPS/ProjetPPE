  ...
  <body onload="adminMenu(), creanauMenu('prof')">
    ...
    <div class="main">
      ...
      <div class="details">
          ...
          <form method="post" action="http://192.168.1.72/ProjetPPE/model/controllers/requetes.php?OperaPPE=4441524b2045434e454c4953&Add=creneau">
						...
						<div class="button">
							<a href="http://192.168.1.72/ProjetPPE/view/admin/creneaux.php"><input type="button" name="time" value='Annulé'></a>
