  ...
  <body onload="creanauMenu('prof')"></body>
	...
	<div class="details">
		...
		<div class="recentOrders">
			...
			<form method="post" action="controllers/requetes.php?OperaPPE=4441524b2045434e454c4953&Add=creneau">
				...
				<div class="button">
					<a href="index.php?OperaPPE=admin&Action=creneaux"><input type="button" name="time" value='Annulé'></a>
